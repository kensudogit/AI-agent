...
const sections = [
  ...
  },
  {
    ...
    items: [
      ...
      '「シナリオを選ぶ」のリモコン盤を開き、次の3つを選択します。（1）シナリオ：B2B SaaS・価格納期・初回訪問・人材紹介・広告契約・外注・エンタープライズライセンス・更新契約・業務提携MOU・賃貸オフィス・コンサル報酬・保守SLAなどから選びます。（2）難易度：易・標準・難（相手AIの態度が協力的〜厳しめに変わります）。（3）あなたの役割：営業側（AIが顧客）か顧客側（AIが営業）。',
      ...
      '一通り商談が終わったら「終了してフィードバック」を押します。AIがログを分析し、良かった点・改善点・アドバイス・総合スコア（1〜5）を表示します。',
