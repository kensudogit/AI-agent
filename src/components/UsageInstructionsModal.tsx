...
const sections = [
  ...
  },
  {
    ...
    items: [
      ...
      '「商談を開始」を押すとセッションが始まります。AIが商談の最初の一言を表示するので、その内容に合わせて返答を入力します。画面上部に経過時間が表示されます。',
      '入力欄に商談のセリフを入力して送信するか、マイクで音声入力します。AIは選択したシナリオ・役割・難易度に合わせて相手役を演じます。やり取りを続けて商談を進めてください。',
